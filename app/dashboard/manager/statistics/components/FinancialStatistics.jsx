...
export function FinancialStatistics() {
  ...
  useEffect(() => {
    const fetchMonthlySalary = async () => {
      try {
        const response = await fetch("/api/user/statistics/financial-stats");
      ...
      {monthlySalaryData.map((stats) => (
        <div className={styles.statisticsCard} key={stats.unique_key}>
          ...
          <Panel
            ...
            value={`${
              stats.current_year_total_revenue
                ? stats.current_year_total_revenue
                : "0"
            } Zł.`}
            lastYearValue={`${
              stats.last_year_total_revenue
                ? stats.last_year_total_revenue
                : "0"
            } Zł`}
          />
          ...
          <Panel
            ...
            value={`${
              stats.current_year_funeral_revenue
                ? stats.current_year_funeral_revenue
                : "0"
            } Zł.`}
            lastYearValue={`${
              stats.last_year_funeral_revenue
                ? stats.last_year_funeral_revenue
                : "0"
            } Zł`}
          />
          ...
          <Panel
            ...
            value={`${
              stats.current_year_transport_revenue
                ? stats.current_year_transport_revenue
                : "0"
            } Zł.`}
            lastYearValue={`${
              stats.last_year_transport_revenue
                ? stats.last_year_transport_revenue
                : "0"
            } Zł`}
          />
          ...
          <Panel
            ...
            value={`${
              stats.current_year_preparation_revenue
                ? stats.current_year_preparation_revenue
                : "0"
            } Zł.`}
            lastYearValue={`${
              stats.last_year_preparation_revenue
                ? stats.last_year_preparation_revenue
                : "0"
            } Zł`}
          />
          ...
          <Panel
            ...
            value={`${
              stats.current_year_working_hours_revenue
                ? stats.current_year_working_hours_revenue
                : "0"
            } Zł.`}
            lastYearValue={`${
              stats.last_year_working_hours_revenue
                ? stats.last_year_working_hours_revenue
                : "0"
            } Zł`}
          />
